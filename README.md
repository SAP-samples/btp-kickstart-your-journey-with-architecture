...
An example, in the video below, showcases our proposed solution.
...
> [!NOTE]
>
> The conversation is shown in Joule Studio's test environment. Upon deployment, the defined custom skill would be accessible through Joule in SAP SuccessFactors.
